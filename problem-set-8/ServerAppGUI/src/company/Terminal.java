            ...
            if (trees_names.contains(commands_list.get(0))) {
                ...
                if (commands_list.get(1).equals("add")) {
                    ...
                    if (treetype.equals("Integer")) {
                        for (int i = 2; i < commands_list.size(); i++) {
                            try {
                                tree.remove(Integer.parseInt(commands_list.get(i)));
                                //System.out.println("Usunięto element z drzewa (" + commands_list.get(i) + ")");
                        ...
                        for (int i = 2; i < commands_list.size(); i++) {
                            try {
                                tree.remove(Double.parseDouble(commands_list.get(i)));
                                //System.out.println("Usunięto element z drzewa (" + commands_list.get(i) + ")");
                        ...
                        for (int i = 2; i < commands_list.size(); i++) {
                            try {
                                tree.remove(commands_list.get(i));
                                //System.out.println("Usunięto element z drzewa (" + commands_list.get(i) + ")");
                    ...
                    if (treetype.equals("Integer")) {
                        try {
                            tree.find(Integer.parseInt(commands_list.get(2)));
                        } catch (IllegalArgumentException e) {
